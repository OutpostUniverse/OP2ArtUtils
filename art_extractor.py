...
def main():
    ...
    parser.add_argument('--palette_format', default='pal', choices=palette.PAL_FORMATS.keys(), help='Palette format to dump.  Choices are pal (Microsoft RIFF .pal format), text (.pal text format supported by Paint Shop Pro), or act (Photoshop .act color table).')
